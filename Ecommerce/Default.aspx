<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCliente.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Ecommerce.Default" %>
    ...
    <div class="row justify-content-center">
       <%-- <%foreach (dominioEcommerce.Producto producto in listaProducto)--%>
        <%for (int i = 0; i < 5; i++)  
            {
        %>
        <div class="card border border-info border border-5 m-2" style="width: 20rem;">
            <img src="https://images.fravega.com/f500/74b5eeb26dd0121b8928b0c9fb038062.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Nombre producto....</h5>
                <p class="card-text">Descripcion del producto........</p>
                <a href="#" class="btn btn-primary">Detalle producto</a>
            </div>
