<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCliente.Master" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="Ecommerce.error" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container d-flex justify-content-center mb-5 mt-5">
        <div class="col-6 p-3 border border-secondary-subtle rounded shadow-sm bg-white">
            <div class="d-flex flex-column align-items-center text-center">
                <h4>Error </h4>
                <svg xmlns="http://www.w3.org/2000/svg" width="16rem" height="16rem" fill="currentColor" class="bi bi-sign-stop m-2" viewBox="0 0 16 16">
                ...
                <asp:Label Text="" ID="lblError" CssClass="fs-4" runat="server" />
            </div>
        </div>
    </div>
</asp:Content>
